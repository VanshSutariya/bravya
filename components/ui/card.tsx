...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-2xl border border-slate-200/80 bg-white/80 p-6 shadow-sm transition hover:shadow-md dark:border-slate-800/80 dark:bg-slate-900/80 dark:shadow-none dark:hover:shadow-soft',
        className,
      )}
      {...props}
    />
